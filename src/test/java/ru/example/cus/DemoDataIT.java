...
import ru.example.cus.integration.application.DemoDataLoader;
...
class DemoDataIT extends AbstractIntegrationTest {
    ...
    void demo_users_of_every_role_can_be_used_to_sign_in() {
        ...
        for (ru.example.cus.common.domain.RoleCode role : ru.example.cus.common.domain.RoleCode.values()) {
