...
class AccessHardeningIT extends AbstractIntegrationTest {
    ...
    @Autowired
    private ru.example.inconsensu.thirdparty.application.ThirdPartyService thirdParties;
    ...
    private Consent registerConsents() {
        UUID thirdPartyId = RunAs.roles("test-dpo", List.of("DPO"), () -> thirdParties
                .create(
                        ...
                        new ru.example.inconsensu.thirdparty.application.ThirdPartyService.ThirdPartyForm(
                                "ООО «Проверка правила»",
                                null,
                                null,
                                "123001, Москва, ул. Тестовая, д. 2",
                                ru.example.inconsensu.common.domain.ThirdPartyRole.PROCESSOR,
                                "ДП-2026/1",
