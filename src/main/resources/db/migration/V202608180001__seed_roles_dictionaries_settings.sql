...
INSERT INTO operator_settings (key, value, updated_at, updated_by) VALUES
    ...
    ('cus.timezone',                     'Europe/Moscow',  TIMESTAMPTZ '2026-08-18 00:00:00+00', 'system'),
    ('cus.status.expiring-days',         '30',             TIMESTAMPTZ '2026-08-18 00:00:00+00', 'system'),
    ('cus.notification.thresholds',      '30,15,7,1',      TIMESTAMPTZ '2026-08-18 00:00:00+00', 'system'),
    ('cus.notification.digest-threshold','20',             TIMESTAMPTZ '2026-08-18 00:00:00+00', 'system'),
    ('cus.export.ttl',                   'PT24H',          TIMESTAMPTZ '2026-08-18 00:00:00+00', 'system'),
    ('cus.approval.required-roles',      'LAWYER,DPO',     TIMESTAMPTZ '2026-08-18 00:00:00+00', 'system'),
    ('cus.revocation.cascade-enabled',   'true',           TIMESTAMPTZ '2026-08-18 00:00:00+00', 'system'),
    ('cus.selfservice.auth-mode',        'SERVICE_TOKEN',  TIMESTAMPTZ '2026-08-18 00:00:00+00', 'system'),
