...
public class CryptoService {
    ...
    public CryptoService(InConsensuProperties properties) {
        InConsensuProperties.Crypto crypto = properties.crypto();
        ...
        if (base64 == null || base64.isBlank()) {
            if (required) {
                throw new IllegalStateException(
                        "Шифрование включено (inconsensu.crypto.enabled), но ключ inconsensu.crypto.key не задан");
            }
            return null;
        }
