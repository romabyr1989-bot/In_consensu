...
public enum ErrorCode {
    ...
    private static final String URN_PREFIX = "urn:inconsensu:error:";
     ...
     * {@link #BAD_REQUEST}, and a lookup would hand {@code urn:inconsensu:error:validation-failed} to every malformed
