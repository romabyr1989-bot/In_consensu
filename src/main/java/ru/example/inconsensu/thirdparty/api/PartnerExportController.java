...
public class PartnerExportController {
    ...
    public PartnerExportController(
            PartnerExportService exports, InConsensuProperties properties, java.time.Clock clock) {
    ...
    public ResponseEntity<String> download(@PathVariable UUID id) {
        ...
        return ResponseEntity.ok()
                ...
                .header("X-InConsensu-File-Checksum", String.valueOf(export.getFileChecksum()))
