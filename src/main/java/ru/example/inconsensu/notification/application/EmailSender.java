...
public class EmailSender {
    ...
    public EmailSender(
            ObjectProvider<JavaMailSender> mailSender, TemplateEngine templateEngine, InConsensuProperties properties) {
    ...
    public String send(String to, String subject, String html) {
        if (!properties.notifications().mail().enabled()) {
            ...
            return "Отправка писем выключена настройкой inconsensu.notifications.mail.enabled";
        }
