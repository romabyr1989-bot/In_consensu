package ru.example.inconsensu.channels.api;
...
public class ChannelController {
    ...
    private final ru.example.inconsensu.channels.application.BulkCheckJobService bulkJobs;
    private final InConsensuProperties properties;

    public ChannelController(
            ChannelService channels,
            ru.example.inconsensu.channels.application.BulkCheckJobService bulkJobs,
    ...
    public record BulkJobResponse(
        ...
        static BulkJobResponse of(ru.example.inconsensu.channels.domain.BulkCheckJob job) {
