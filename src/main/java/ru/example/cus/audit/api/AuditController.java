...
import ru.example.cus.audit.application.AuditVerificationService;
    ...
    public record VerificationResponse(
        ...
        static VerificationResponse of(AuditVerification verification, java.time.ZoneId zone) {
            return new VerificationResponse(
                    ...
                    ru.example.cus.common.api.ApiTime.at(verification.getStartedAt(), zone),
                    ru.example.cus.common.api.ApiTime.at(verification.getFinishedAt(), zone),
