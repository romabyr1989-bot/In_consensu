...
import ru.example.cus.common.error.ProblemDetailWriter;
 ...
 * {@link ru.example.cus.ui.infrastructure.UiSecurityConfig} with a server side session and CSRF (UI-0.3): a browser
...
public class SecurityConfig {
    ...
    public SecurityConfig(
            ru.example.cus.common.config.CusProperties properties, ProblemDetailWriter problemDetailWriter) {
