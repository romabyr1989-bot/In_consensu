...
public class AdminBootstrap implements ApplicationRunner {
    ...
    public AdminBootstrap(AppUserRepository users, UserService userService, CusProperties properties) {
        this.users = users;
    ...
    public void run(ApplicationArguments args) {
        ...
        if (login.isBlank() || password.isBlank()) {
            LOG.warn("Таблица пользователей пуста, а CUS_ADMIN_LOGIN / CUS_ADMIN_PASSWORD не заданы: "
