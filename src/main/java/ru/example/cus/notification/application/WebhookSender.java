...
public class WebhookSender {
    ...
    public static final String EVENT_HEADER = "X-Cus-Event";
    public static final String DELIVERY_HEADER = "X-Cus-Delivery-Id";
    ...
    public WebhookSender(
            RestTemplateBuilder builder, ObjectMapper objectMapper, CusProperties properties, Clock clock) {
        CusProperties.Webhook webhook = properties.notifications().webhook();
        this.restTemplate = builder.connectTimeout(webhook.connectTimeout())
                .readTimeout(webhook.readTimeout())
                .defaultHeader(HttpHeaders.USER_AGENT, "CUS-Webhook/1.0")
                .build();
