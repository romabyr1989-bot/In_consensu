...
public interface OutboxEventRepository extends JpaRepository<OutboxEvent, UUID> {
    ...
    @Query(
            ...
            where e.status in (ru.example.cus.notification.domain.OutboxStatus.PENDING,
                               ru.example.cus.notification.domain.OutboxStatus.RETRY)
    ...
    @Query(
            ...
            where e.aggregateType = :aggregateType and e.aggregateId = :aggregateId
              and e.status in (ru.example.cus.notification.domain.OutboxStatus.PENDING,
                               ru.example.cus.notification.domain.OutboxStatus.RETRY)
