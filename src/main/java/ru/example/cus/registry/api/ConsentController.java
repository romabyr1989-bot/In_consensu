...
public class ConsentController {
    ...
    private final ru.example.cus.registry.application.RevocationService revocation;
    private final com.fasterxml.jackson.databind.ObjectMapper objectMapper;
    private final ru.example.cus.common.config.CusProperties properties;
    ...
    public ConsentController(
            ...
            ru.example.cus.registry.application.RevocationService revocation,
            com.fasterxml.jackson.databind.ObjectMapper objectMapper,
            ru.example.cus.common.config.CusProperties properties) {
    ...
    @GetMapping
    public ru.example.cus.common.api.PageResponse<ConsentResponse> list(
        ...
        var page = queries.search(
                ...
                pageable);
        return new ru.example.cus.common.api.PageResponse<>(
                assembler.toResponses(
    ...
    public record RevokeRequest(
            ...
            @jakarta.validation.constraints.NotNull ru.example.cus.common.domain.RevocationSource revocationSource,
    ...
    public RevocationResponse revoke(@PathVariable UUID id, @Valid @RequestBody RevokeRequest request) {
        ...
        return new RevocationResponse(
                ...
                ru.example.cus.common.api.ApiTime.at(result.revokedAt(), properties.timezone()),
                ru.example.cus.common.api.ApiTime.at(result.processingStopDeadline(), properties.timezone()),
                result.caseNumber(),
